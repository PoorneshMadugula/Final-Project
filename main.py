...
def fileupload():
    ...
    if result>45:
        return render_template("predicted.html",predict=result,msg="Consult a healthcare professional for proper evaluation and diagnosis if you're concerned about cancer.")
    return render_template("predicted.html",predict=result,msg="No online tool can definitively confirm the absence of cancer. Consult a healthcare professional for accurate evaluation and peace of mind.")
